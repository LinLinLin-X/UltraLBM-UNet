...
class setting_config:
    ...
    network = 'UltraLBM_UNet'

    datasets = 'isic17' 
    if datasets == 'isic18':
        data_path = '/data/ISIC/isic2018/'
    elif datasets == 'isic17':
        data_path = '/data//ISIC/isic2017/'
    elif datasets == 'ph2':
        data_path = '/data//PH2/'
    else:
    ...
    work_dir = 'results/' + network + '_' + str(seed) + '_' + datasets + '_' + datetime.now().strftime('%A_%d_%B_%Y_%Hh_%Mm_%Ss') + '/'
